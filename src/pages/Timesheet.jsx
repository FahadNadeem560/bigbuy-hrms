      ...
      {!loading && selectedEmp && (
        <>
          ...
          <div id="timesheet-print-root">
            ...
            {/* Attendance Ledger */}
            <div className="bg-white border border-slate-100 rounded-2xl shadow-sm mb-4 overflow-x-auto overflow-y-auto max-h-[70vh] print:rounded-none print:border-0 print:shadow-none print:mb-1">
