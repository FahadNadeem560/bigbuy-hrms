...
export default function PayrollHold({ role, actorName, month, setMonth }) {
  ...
  return (
    <div>
      ...
      {/* Section 1: Hold */}
      <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-x-auto mb-6">
      ...
      {/* Section 3: F&F */}
      <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-x-auto mt-6">
